...
place_pad -row IO_WEST  -location [expr $start -  2*$pitch] "pad_fetch_en_i"   ; # pin no:  3
place_pad -row IO_WEST  -location [expr $start -  3*$pitch] "pad_status_o"     ; # pin no:  4
place_pad -row IO_WEST  -location [expr $start -  4*$pitch] "pad_clk_i"        ; # pin no:  5
place_pad -row IO_WEST  -location [expr $start -  5*$pitch] "pad_ref_clk_i"    ; # pin no:  6
place_pad -row IO_WEST  -location [expr $start -  6*$pitch] "pad_rst_ni"       ; # pin no:  7
place_pad -row IO_WEST  -location [expr $start -  7*$pitch] "pad_vss0"         ; # pin no:  8
place_pad -row IO_WEST  -location [expr $start -  8*$pitch] "pad_vdd0"         ; # pin no:  9
...
place_pad -row IO_SOUTH  -location [expr $start +  2*$pitch] "pad_jtag_tck_i"   ; # pin no:  3
place_pad -row IO_SOUTH  -location [expr $start +  3*$pitch] "pad_jtag_trst_ni" ; # pin no:  4
place_pad -row IO_SOUTH  -location [expr $start +  4*$pitch] "pad_jtag_tms_i"   ; # pin no:  5
place_pad -row IO_SOUTH  -location [expr $start +  5*$pitch] "pad_jtag_tdi_i"   ; # pin no:  6
place_pad -row IO_SOUTH  -location [expr $start +  6*$pitch] "pad_jtag_tdo_o"   ; # pin no:  7
place_pad -row IO_SOUTH  -location [expr $start +  7*$pitch] "pad_vss1"         ; # pin no:  8
place_pad -row IO_SOUTH  -location [expr $start +  8*$pitch] "pad_vdd1"         ; # pin no:  9
...
place_pad -row IO_EAST  -location [expr $start +  2*$pitch] "pad_uart_rx_i"    ; # pin no:  3
place_pad -row IO_EAST  -location [expr $start +  3*$pitch] "pad_uart_tx_o"    ; # pin no:  4
place_pad -row IO_EAST  -location [expr $start +  7*$pitch] "pad_vss2"         ; # pin no:  8
place_pad -row IO_EAST  -location [expr $start +  8*$pitch] "pad_vdd2"         ; # pin no:  9
...
place_pad -row IO_NORTH  -location [expr $start -  7*$pitch] "pad_vss3"            ; # pin no:  8
place_pad -row IO_NORTH  -location [expr $start -  8*$pitch] "pad_vdd3"            ; # pin no:  9
